...
async function handleUpload(from, Gifted, conText, service) {
    const { mek, reply, react, botFooter, botPrefix, quotedMsg, getMediaBuffer, uploadToGiftedCdn, uploadToGithubCdn, uploadToPixhost, getFileContentType, uploadToImgBB, uploadToPasteboard, uploadToCatbox, pushName } = conText;
